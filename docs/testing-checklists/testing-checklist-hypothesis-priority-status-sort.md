...
- [ ] Порядок статусов при вторичной сортировке: New → Accepted → In Progress → Done → Rejected
...
- [ ] При активации сортировки по возрастанию гипотезы сортируются: New → Accepted → In Progress → Done → Rejected
- [ ] Гипотезы со статусом "New" идут первыми
- [ ] Гипотезы со статусом "Rejected" идут последними

### 4.3 Сортировка по убыванию статуса
- [ ] При активации сортировки по убыванию гипотезы сортируются в обратном порядке: Rejected → Done → In Progress → Accepted → New
...
- [ ] Порядок статусов в меню выбора: New → In Progress → Accepted → Done → Rejected
- [ ] Сортировка по статусу работает корректно
- [ ] Порядок статусов при сортировке: New → Accepted → In Progress → Done → Rejected
